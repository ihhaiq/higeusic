...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/ihhaiq/higeusic")
...
LONG_VIDEO_MAX_QUALITY = int(getenv("LONG_VIDEO_MAX_QUALITY", "360"))
LONG_VIDEO_SEGMENT_MIN = max(2, int(getenv("LONG_VIDEO_SEGMENT_MIN", "8")))
LONG_VIDEO_DOWNLOAD_CONCURRENCY = max(
    1, int(getenv("LONG_VIDEO_DOWNLOAD_CONCURRENCY", "1"))
)
LONG_VIDEO_PREFETCH_DELAY_SEC = max(
    0, int(getenv("LONG_VIDEO_PREFETCH_DELAY_SEC", "45"))
)
TELEGRAM_MEDIA_FALLBACK_RETRIES = max(
    1, int(getenv("TELEGRAM_MEDIA_FALLBACK_RETRIES", "3"))
)
TELEGRAM_MEDIA_FALLBACK_RETRY_DELAY = max(
    0, int(getenv("TELEGRAM_MEDIA_FALLBACK_RETRY_DELAY", "3"))
)
